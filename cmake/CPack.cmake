...
list(PREPEND CPACK_COMPONENTS_ALL PVN)
...
set(CPACK_IFW_PACKAGE_NAME                          PVN)
set(CPACK_IFW_PACKAGE_TITLE                         PVN)
...
set(CPACK_PRODUCTBUILD_IDENTIFIER       com.pvn.vpn)
set(CPACK_PREFLIGHT_PVN_SCRIPT          ${CMAKE_SOURCE_DIR}/deploy/data/macos/post_uninstall.sh)
set(CPACK_POSTFLIGHT_PVN_SCRIPT         ${CMAKE_SOURCE_DIR}/deploy/data/macos/post_install.sh)
