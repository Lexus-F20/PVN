...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("PVN logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("PVN-service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/PVN-service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)
