...
PageType {
    ...
    QtObject {
        ...
        readonly property string title: qsTr("Check the server for previously installed PVN services")
        readonly property string description: qsTr("Add them to the application if they were not displayed")
        readonly property var tColor: PvnStyle.color.paleGray
    ...
    QtObject {
        ...
        readonly property var tColor: PvnStyle.color.vibrantRed
        readonly property var clickedHandler: function() {
    ...
    QtObject {
        ...
        readonly property var clickedHandler: function() {
            ...
            var descriptionText = qsTr("All installed PVN services will still remain on the server.")
            var yesButtonText = qsTr("Continue")
            var noButtonText = qsTr("Cancel")
    ...
    QtObject {
        ...
        property bool isVisible: root.isServerWithWriteAccess
        readonly property string title: qsTr("Clear server from PVN software")
        readonly property string description: ""
        readonly property var tColor: PvnStyle.color.vibrantRed
        readonly property var clickedHandler: function() {
            var headerText = qsTr("Do you want to clear server from PVN software?")
            ...
            var yesButtonFunction = function() {
                if (ServersUiController.isDefaultServerCurrentlyProcessed() && ConnectionController.isConnected) {
                    PageController.showNotificationMessage(qsTr("Cannot clear server from PVN software during active connection"))
                } else {
