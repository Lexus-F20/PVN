                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        CaptionTextType {
                            ...
                            color: secret !== "" ? PvnStyle.color.goldenApricot : PvnStyle.color.mutedGray
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        CaptionTextType {
                            Layout.fillWidth: true
                            text: tgLink()
                            color: PvnStyle.color.goldenApricot
                            elide: Text.ElideRight
                            maximumLineCount: 1
                            font.pixelSize: 13
                        }
        ...
        ListViewType {
            ...
            delegate: ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        CaptionTextType {
                            ...
                            color: secret !== "" ? PvnStyle.color.paleGray : PvnStyle.color.mutedGray
                            wrapMode: Text.WrapAnywhere
                            font.pixelSize: 14
                        }
                    ...
                    listView: Component {
                        ListViewType {
                            ...
                            delegate: LabelWithButtonType {
                                ...
                                rightImageColor: PvnStyle.color.goldenApricot
                                clickedFunction: function () {
                ...
                LabelWithButtonType {
                    ...
                    rightImageColor: PvnStyle.color.mutedGray
                    clickedFunction: function () {
                        expanded = !expanded
                    }
                }
                    ...
                    Repeater {
                        ...
                        delegate: RowLayout {
                            ...
                            ImageButtonType {
                                ...
                                hoverEnabled: true
                                image: "qrc:/images/controls/copy.svg"
                                imageColor: PvnStyle.color.mutedGray
                            ...
                            ImageButtonType {
                                ...
                                imageColor: PvnStyle.color.vibrantRed
                                onClicked: {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ImageButtonType {
                            ...
                            implicitHeight: 32
                            image: "qrc:/images/controls/refresh-cw.svg"
                            imageColor: diagLoading ? PvnStyle.color.mutedGray : PvnStyle.color.paleGray
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            height: 8
                            radius: 4
                            color: diagClientsConnected >= 0 ? (diagPortReachable ? PvnStyle.color.paleGray : PvnStyle.color.vibrantRed) : PvnStyle.color.mutedGray
                        }
                        CaptionTextType {
                            Layout.fillWidth: true
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            height: 8
                            radius: 4
                            color: diagClientsConnected >= 0 ? (diagTelegramReachable ? PvnStyle.color.paleGray : PvnStyle.color.vibrantRed) : PvnStyle.color.mutedGray
                        }
                        CaptionTextType {
                            Layout.fillWidth: true
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            height: 8
                            radius: 4
                            color: diagClientsConnected >= 0 ? PvnStyle.color.goldenApricot : PvnStyle.color.mutedGray
                        }
                        CaptionTextType {
                            Layout.fillWidth: true
