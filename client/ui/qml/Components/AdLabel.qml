...
Rectangle {
    ...
    gradient: Gradient {
        ...
        GradientStop { position: 0.0; color: PvnStyle.color.translucentSlateGray }
        GradientStop { position: 1.0; color: PvnStyle.color.translucentOnyxBlack }
    }
    border.width: 1
    border.color: PvnStyle.color.onyxBlack
    radius: 13
    ...
    RowLayout {
        ...
        Item {
            ...
            Rectangle {
                ...
                border.color: PvnStyle.color.paleGray
    ...
    MouseArea {
        ...
        onEntered: {
            chevronBackground.color = PvnStyle.color.slateGray
        }

        onExited: {
            chevronBackground.color = PvnStyle.color.transparent
        }

        onPressedChanged: {
            chevronBackground.color = pressed ? PvnStyle.color.charcoalGray : containsMouse ? PvnStyle.color.slateGray : PvnStyle.color.transparent
        }
