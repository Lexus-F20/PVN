...
Rectangle {
    ...
    border.color: selected ? PvnStyle.color.goldenApricot : PvnStyle.color.charcoalGray
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            LabelTextType {
                ...
                color: root.selected ? PvnStyle.color.goldenApricot : PvnStyle.color.paleGray
                font.pixelSize: 17
