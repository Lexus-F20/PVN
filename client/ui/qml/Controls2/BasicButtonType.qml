...
Button {
    ...
    property string hoveredColor: PvnStyle.color.lightGray
    property string defaultColor: PvnStyle.color.paleGray
    property string disabledColor: PvnStyle.color.charcoalGray
    property string pressedColor: PvnStyle.color.mutedGray

    property string textColor: PvnStyle.color.midnightBlack

    property string borderColor: PvnStyle.color.paleGray
