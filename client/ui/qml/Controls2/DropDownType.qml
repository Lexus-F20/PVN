...
Item {
    ...
    property string rootButtonImageColor: PvnStyle.color.paleGray
    property string rootButtonBackgroundColor: PvnStyle.color.onyxBlack
    property string rootButtonBackgroundHoveredColor: PvnStyle.color.onyxBlack
    property string rootButtonBackgroundPressedColor: PvnStyle.color.onyxBlack

    property string borderFocusedColor: PvnStyle.color.paleGray
    property int borderFocusedWidth: 1

    property string rootButtonHoveredBorderColor: PvnStyle.color.charcoalGray
    property string rootButtonDefaultBorderColor: PvnStyle.color.slateGray
    property string rootButtonPressedBorderColor: PvnStyle.color.paleGray
        ...
        Rectangle {
            ...
            color: {
                if (root.enabled) {
                    ...
                    return PvnStyle.color.transparent
                }
            }
