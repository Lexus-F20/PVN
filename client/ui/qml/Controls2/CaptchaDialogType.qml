        ...
        ColumnLayout {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    anchors.fill: parent
                    color: PvnStyle.color.pearlGray
                    radius: 16
            ...
            TextFieldWithHeaderType {
                ...
                headerTextColor: PvnStyle.color.mutedGray

                textField.placeholderText: qsTr("_ _ _ _ _ _")
                textField.placeholderTextColor: PvnStyle.color.mutedGray
            ...
            BasicButtonType {
                ...
                text: qsTr("Continue")
                defaultColor: PvnStyle.color.paleGray
                hoveredColor: PvnStyle.color.lightGray
                pressedColor: PvnStyle.color.mutedGray
            ...
            BasicButtonType {
                ...
                borderWidth: 1
                borderColor: PvnStyle.color.mutedGray
                borderFocusedColor: PvnStyle.color.paleGray
