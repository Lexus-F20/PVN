...
set_target_properties(${PROJECT} PROPERTIES
    ...
    MACOSX_BUNDLE_INFO_STRING "PVN"
    MACOSX_BUNDLE_BUNDLE_NAME "PVN"
    ...
    XCODE_ATTRIBUTE_PRODUCT_NAME "PVN"
    XCODE_ATTRIBUTE_BUNDLE_INFO_STRING "PVN"
    ...
    XCODE_EMBED_APP_EXTENSIONS PVNNetworkExtension
)
...
if(DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr macos.org.amnezia.PVN"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev macos.org.amnezia.PVN"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
set_target_properties(${PROJECT} PROPERTIES
    ...
    XCODE_ATTRIBUTE_SWIFT_OBJC_INTERFACE_HEADER_NAME "PVN-Swift.h"
...
add_dependencies(${PROJECT} PVNNetworkExtension)
...
add_custom_command(TARGET ${PROJECT} POST_BUILD
    COMMAND ${QT_BIN_DIR_DETECTED}/macdeployqt $<TARGET_BUNDLE_DIR:PVN> -appstore-compliant -qmldir=${CMAKE_CURRENT_SOURCE_DIR}
)
