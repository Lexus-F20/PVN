...
#define TUNNEL_NAMED_PIPE \
  "\\\\."                 \
  "\\pipe\\ProtectedPrefix\\Administrators\\AmneziaWG\\PVN"
...
bool WindowsTunnelService::start(const QString& configData) {
  ...
  service = CreateService(scm, TUNNEL_SERVICE_NAME, L"PVN (tunnel)",
  ...
  SERVICE_DESCRIPTION sd = {
      (wchar_t*)L"Manages the PVN tunnel connection"};
